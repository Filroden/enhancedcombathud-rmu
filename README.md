...
| Version   | Changes |
| :--- | :--- |
| **0.5.0** | * Refactored and modularised the codebase.<br>* Added spell SCR (Spell panel) and Attack rolls (attack panel). Spell Mastery rolls were already available in the Skills panel.<br>* Added additional styling for dual level accordion panels for SCR rolls. |
